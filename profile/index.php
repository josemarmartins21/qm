...
// trocar para cliente
$dad = $qmanager->prepare("SELECT client_id, primeiro_nome, ultimo_nome, email, telefone FROM client WHERE client_id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $pode_editar) {
    ...
    $novo_is_adm = intval($_POST['telefone']);
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number">#<?php echo $user['client_id']; ?></div>
        ...
        <form method="POST" action="">
            ...
            <?php if ($pode_editar): ?>
                <div class="form-group">
                <label for="tipo_visualizacao">Cliente</label>
